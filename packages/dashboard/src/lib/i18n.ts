...
const TEXT = {
  en: {
    ...
    daysRemaining: (count: number) => `${count} days`,
    today: "Today",
    earlier: "Earlier",
    ...
    siteNotFoundHint: "It may have been removed from the config.",
    siteAccessDenied: "You don't have access to this site",
    siteAccessDeniedHint: "It belongs to a group outside your scope.",
    uptime7d: "Uptime 7d",
    uptime30d: "Uptime 30d",
    last90Days: "Last 90 days",
    siteResponseTime: "Response time",
    ...
    registrar: "Registrar",
    noIncidentsHealthy: "This site has been healthy.",
  ...
  zh: {
    ...
    daysRemaining: (count: number) => `${count} 天`,
    today: "今天",
    earlier: "更早时间",
    operational: "运行正常",
    degraded: "性能下降",
    ...
    back: "返回",
    siteNotFound: "未找到站点",
    siteNotFoundHint: "它可能已从配置中移除。",
    siteAccessDenied: "你无权访问此站点",
    siteAccessDeniedHint: "它属于你权限范围外的分组。",
    uptime7d: "7 天可用率",
    uptime30d: "30 天可用率",
    last90Days: "最近 90 天",
    siteResponseTime: "响应时间",
    sslDomain: "SSL 与域名",
    last24h: "最近 24 小时",
    last7days: "最近 7 天",
    last30days: "最近 30 天",
